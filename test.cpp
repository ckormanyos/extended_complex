...
namespace local
{
  ...
  auto test() -> bool
  {
    ...
    const complex_type result_34 = polar(real(val_z1), imag(val_z1));                     // N[(12/10) Sin[34/10], 100]
    const complex_type result_35 = asinh( val_z1);                                        // N[ArcSinh[(12/10) + ((34 I)/10)], 100]
    const complex_type result_36 = pow  ( val_z1, real(val_z2));                          // N[((12/10) + ((34  I)/10))^(56/10), 100]
    ...
    // Ensure that I/O-streaming works.
    {
      ...
      const auto result_strm_is_ok = (   util::is_close_fraction(result_07.real(), ctrl.real(), tol)
                                      && util::is_close_fraction(result_07.imag(), ctrl.imag(), tol));
    ...
    const complex_type control_34(my_lexical_cast<float_type>("-1.160157831095353217138641847718832693435133312218689112813374970441475461642610761182658854558181536"),     my_lexical_cast<float_type>("-0.3066493224321975830998829152364868909731044553212128930029322191624776241668759313403878234532577257"));
    const complex_type control_35(my_lexical_cast<float_type>("+1.960545624274756532757863147926614306606344023611895252748744677291286163242757958621205801565261868"),     my_lexical_cast<float_type>("+1.218868916639890129907167289780557894460959308403278313426586722860313100564201336738382323265397208"));
    const complex_type control_36(my_lexical_cast<float_type>("+1075.6805191639861506830414639044966711703716516323548185326564518164749257825424444319746454671929861"),    my_lexical_cast<float_type>("+757.0056142100587075756938634657815779527417605180144717715079634951737840220579027084893574878213686"));
    ...
    { const auto result_real_is_ok = util::is_close_fraction(result_03.real(), control_03.real(), tol); const auto result_imag_is_ok = util::is_close_fraction(result_03.imag(), control_03.imag(), tol); BOOST_TEST(result_real_is_ok); BOOST_TEST(result_imag_is_ok); result_is_ok = (result_real_is_ok && result_imag_is_ok && result_is_ok); std::stringstream strm { }; strm << "result_real_is_ok: " << std::boolalpha << result_real_is_ok << ", result_imag_is_ok: " << std::boolalpha << result_imag_is_ok; std::cout << strm.str() << std::endl; }
    { const auto result_real_is_ok = util::is_close_fraction(result_04.real(), control_04.real(), tol); const auto result_imag_is_ok = util::is_close_fraction(result_04.imag(), control_04.imag(), tol); BOOST_TEST(result_real_is_ok); BOOST_TEST(result_imag_is_ok); result_is_ok = (result_real_is_ok && result_imag_is_ok && result_is_ok); std::stringstream strm { }; strm << "result_real_is_ok: " << std::boolalpha << result_real_is_ok << ", result_imag_is_ok: " << std::boolalpha << result_imag_is_ok; std::cout << strm.str() << std::endl; }
    { const auto result_real_is_ok = util::is_close_fraction(result_05.real(), control_05.real(), tol); const auto result_imag_is_ok = util::is_close_fraction(result_05.imag(), control_05.imag(), tol); BOOST_TEST(result_real_is_ok); BOOST_TEST(result_imag_is_ok); result_is_ok = (result_real_is_ok && result_imag_is_ok && result_is_ok); std::stringstream strm { }; strm << "result_real_is_ok: " << std::boolalpha << result_real_is_ok << ", result_imag_is_ok: " << std::boolalpha << result_imag_is_ok; std::cout << strm.str() << std::endl; }
    { const auto result_real_is_ok = util::is_close_fraction(result_06.real(), control_06.real(), tol); const auto result_imag_is_ok = util::is_close_fraction(result_06.imag(), control_06.imag(), tol); BOOST_TEST(result_real_is_ok); BOOST_TEST(result_imag_is_ok); result_is_ok = (result_real_is_ok && result_imag_is_ok && result_is_ok); std::stringstream strm { }; strm << "result_real_is_ok: " << std::boolalpha << result_real_is_ok << ", result_imag_is_ok: " << std::boolalpha << result_imag_is_ok; std::cout << strm.str() << std::endl; }
    { const auto result_real_is_ok = util::is_close_fraction(result_07.real(), control_07.real(), tol); const auto result_imag_is_ok = util::is_close_fraction(result_07.imag(), control_07.imag(), tol); BOOST_TEST(result_real_is_ok); BOOST_TEST(result_imag_is_ok); result_is_ok = (result_real_is_ok && result_imag_is_ok && result_is_ok); std::stringstream strm { }; strm << "result_real_is_ok: " << std::boolalpha << result_real_is_ok << ", result_imag_is_ok: " << std::boolalpha << result_imag_is_ok; std::cout << strm.str() << std::endl; }
    { const auto result_real_is_ok = util::is_close_fraction(result_08.real(), control_08.real(), tol); const auto result_imag_is_ok = util::is_close_fraction(result_08.imag(), control_08.imag(), tol); BOOST_TEST(result_real_is_ok); BOOST_TEST(result_imag_is_ok); result_is_ok = (result_real_is_ok && result_imag_is_ok && result_is_ok); std::stringstream strm { }; strm << "result_real_is_ok: " << std::boolalpha << result_real_is_ok << ", result_imag_is_ok: " << std::boolalpha << result_imag_is_ok; std::cout << strm.str() << std::endl; }
    { const auto result_real_is_ok = util::is_close_fraction(result_09.real(), control_09.real(), tol); const auto result_imag_is_ok = util::is_close_fraction(result_09.imag(), control_09.imag(), tol); BOOST_TEST(result_real_is_ok); BOOST_TEST(result_imag_is_ok); result_is_ok = (result_real_is_ok && result_imag_is_ok && result_is_ok); std::stringstream strm { }; strm << "result_real_is_ok: " << std::boolalpha << result_real_is_ok << ", result_imag_is_ok: " << std::boolalpha << result_imag_is_ok; std::cout << strm.str() << std::endl; }
    { const auto result_real_is_ok = util::is_close_fraction(result_10.real(), control_10.real(), tol); const auto result_imag_is_ok = util::is_close_fraction(result_10.imag(), control_10.imag(), tol); BOOST_TEST(result_real_is_ok); BOOST_TEST(result_imag_is_ok); result_is_ok = (result_real_is_ok && result_imag_is_ok && result_is_ok); std::stringstream strm { }; strm << "result_real_is_ok: " << std::boolalpha << result_real_is_ok << ", result_imag_is_ok: " << std::boolalpha << result_imag_is_ok; std::cout << strm.str() << std::endl; }
    { const auto result_real_is_ok = util::is_close_fraction(result_11.real(), control_11.real(), tol); const auto result_imag_is_ok = util::is_close_fraction(result_11.imag(), control_11.imag(), tol); BOOST_TEST(result_real_is_ok); BOOST_TEST(result_imag_is_ok); result_is_ok = (result_real_is_ok && result_imag_is_ok && result_is_ok); std::stringstream strm { }; strm << "result_real_is_ok: " << std::boolalpha << result_real_is_ok << ", result_imag_is_ok: " << std::boolalpha << result_imag_is_ok; std::cout << strm.str() << std::endl; }
    { const auto result_real_is_ok = util::is_close_fraction(result_12.real(), control_12.real(), tol); const auto result_imag_is_ok = util::is_close_fraction(result_12.imag(), control_12.imag(), tol); BOOST_TEST(result_real_is_ok); BOOST_TEST(result_imag_is_ok); result_is_ok = (result_real_is_ok && result_imag_is_ok && result_is_ok); std::stringstream strm { }; strm << "result_real_is_ok: " << std::boolalpha << result_real_is_ok << ", result_imag_is_ok: " << std::boolalpha << result_imag_is_ok; std::cout << strm.str() << std::endl; }
    { const auto result_real_is_ok = util::is_close_fraction(result_13.real(), control_13.real(), tol); const auto result_imag_is_ok = util::is_close_fraction(result_13.imag(), control_13.imag(), tol); BOOST_TEST(result_real_is_ok); BOOST_TEST(result_imag_is_ok); result_is_ok = (result_real_is_ok && result_imag_is_ok && result_is_ok); std::stringstream strm { }; strm << "result_real_is_ok: " << std::boolalpha << result_real_is_ok << ", result_imag_is_ok: " << std::boolalpha << result_imag_is_ok; std::cout << strm.str() << std::endl; }
    { const auto result_real_is_ok = util::is_close_fraction(result_14.real(), control_14.real(), tol); const auto result_imag_is_ok = util::is_close_fraction(result_14.imag(), control_14.imag(), tol); BOOST_TEST(result_real_is_ok); BOOST_TEST(result_imag_is_ok); result_is_ok = (result_real_is_ok && result_imag_is_ok && result_is_ok); std::stringstream strm { }; strm << "result_real_is_ok: " << std::boolalpha << result_real_is_ok << ", result_imag_is_ok: " << std::boolalpha << result_imag_is_ok; std::cout << strm.str() << std::endl; }
    { const auto result_real_is_ok = util::is_close_fraction(result_15.real(), control_15.real(), tol); const auto result_imag_is_ok = util::is_close_fraction(result_15.imag(), control_15.imag(), tol); BOOST_TEST(result_real_is_ok); BOOST_TEST(result_imag_is_ok); result_is_ok = (result_real_is_ok && result_imag_is_ok && result_is_ok); std::stringstream strm { }; strm << "result_real_is_ok: " << std::boolalpha << result_real_is_ok << ", result_imag_is_ok: " << std::boolalpha << result_imag_is_ok; std::cout << strm.str() << std::endl; }
    { const auto result_real_is_ok = util::is_close_fraction(result_16.real(), control_16.real(), tol); const auto result_imag_is_ok = util::is_close_fraction(result_16.imag(), control_16.imag(), tol); BOOST_TEST(result_real_is_ok); BOOST_TEST(result_imag_is_ok); result_is_ok = (result_real_is_ok && result_imag_is_ok && result_is_ok); std::stringstream strm { }; strm << "result_real_is_ok: " << std::boolalpha << result_real_is_ok << ", result_imag_is_ok: " << std::boolalpha << result_imag_is_ok; std::cout << strm.str() << std::endl; }
    { const auto result_real_is_ok = util::is_close_fraction(result_17.real(), control_17.real(), tol); const auto result_imag_is_ok = util::is_close_fraction(result_17.imag(), control_17.imag(), tol); BOOST_TEST(result_real_is_ok); BOOST_TEST(result_imag_is_ok); result_is_ok = (result_real_is_ok && result_imag_is_ok && result_is_ok); std::stringstream strm { }; strm << "result_real_is_ok: " << std::boolalpha << result_real_is_ok << ", result_imag_is_ok: " << std::boolalpha << result_imag_is_ok; std::cout << strm.str() << std::endl; }
    { const auto result_real_is_ok = util::is_close_fraction(result_18.real(), control_18.real(), tol); const auto result_imag_is_ok = util::is_close_fraction(result_18.imag(), control_18.imag(), tol); BOOST_TEST(result_real_is_ok); BOOST_TEST(result_imag_is_ok); result_is_ok = (result_real_is_ok && result_imag_is_ok && result_is_ok); std::stringstream strm { }; strm << "result_real_is_ok: " << std::boolalpha << result_real_is_ok << ", result_imag_is_ok: " << std::boolalpha << result_imag_is_ok; std::cout << strm.str() << std::endl; }
    { const auto result_real_is_ok = util::is_close_fraction(result_19.real(), control_19.real(), tol); const auto result_imag_is_ok = util::is_close_fraction(result_19.imag(), control_19.imag(), tol); BOOST_TEST(result_real_is_ok); BOOST_TEST(result_imag_is_ok); result_is_ok = (result_real_is_ok && result_imag_is_ok && result_is_ok); std::stringstream strm { }; strm << "result_real_is_ok: " << std::boolalpha << result_real_is_ok << ", result_imag_is_ok: " << std::boolalpha << result_imag_is_ok; std::cout << strm.str() << std::endl; }
    { const auto result_real_is_ok = util::is_close_fraction(result_20.real(), control_20.real(), tol); const auto result_imag_is_ok = util::is_close_fraction(result_20.imag(), control_20.imag(), tol); BOOST_TEST(result_real_is_ok); BOOST_TEST(result_imag_is_ok); result_is_ok = (result_real_is_ok && result_imag_is_ok && result_is_ok); std::stringstream strm { }; strm << "result_real_is_ok: " << std::boolalpha << result_real_is_ok << ", result_imag_is_ok: " << std::boolalpha << result_imag_is_ok; std::cout << strm.str() << std::endl; }
    { const auto result_real_is_ok = util::is_close_fraction(result_21.real(), control_21.real(), tol); const auto result_imag_is_ok = util::is_close_fraction(result_21.imag(), control_21.imag(), tol); BOOST_TEST(result_real_is_ok); BOOST_TEST(result_imag_is_ok); result_is_ok = (result_real_is_ok && result_imag_is_ok && result_is_ok); std::stringstream strm { }; strm << "result_real_is_ok: " << std::boolalpha << result_real_is_ok << ", result_imag_is_ok: " << std::boolalpha << result_imag_is_ok; std::cout << strm.str() << std::endl; }
    { const auto result_real_is_ok = util::is_close_fraction(result_22.real(), control_22.real(), tol); const auto result_imag_is_ok = util::is_close_fraction(result_22.imag(), control_22.imag(), tol); BOOST_TEST(result_real_is_ok); BOOST_TEST(result_imag_is_ok); result_is_ok = (result_real_is_ok && result_imag_is_ok && result_is_ok); std::stringstream strm { }; strm << "result_real_is_ok: " << std::boolalpha << result_real_is_ok << ", result_imag_is_ok: " << std::boolalpha << result_imag_is_ok; std::cout << strm.str() << std::endl; }
    { const auto result_real_is_ok = util::is_close_fraction(result_23.real(), control_23.real(), tol); const auto result_imag_is_ok = util::is_close_fraction(result_23.imag(), control_23.imag(), tol); BOOST_TEST(result_real_is_ok); BOOST_TEST(result_imag_is_ok); result_is_ok = (result_real_is_ok && result_imag_is_ok && result_is_ok); std::stringstream strm { }; strm << "result_real_is_ok: " << std::boolalpha << result_real_is_ok << ", result_imag_is_ok: " << std::boolalpha << result_imag_is_ok; std::cout << strm.str() << std::endl; }
    { const auto result_real_is_ok = util::is_close_fraction(result_24.real(), control_24.real(), tol); const auto result_imag_is_ok = util::is_close_fraction(result_24.imag(), control_24.imag(), tol); BOOST_TEST(result_real_is_ok); BOOST_TEST(result_imag_is_ok); result_is_ok = (result_real_is_ok && result_imag_is_ok && result_is_ok); std::stringstream strm { }; strm << "result_real_is_ok: " << std::boolalpha << result_real_is_ok << ", result_imag_is_ok: " << std::boolalpha << result_imag_is_ok; std::cout << strm.str() << std::endl; }
    { const auto result_real_is_ok = util::is_close_fraction(result_25.real(), control_25.real(), tol); const auto result_imag_is_ok = util::is_close_fraction(result_25.imag(), control_25.imag(), tol); BOOST_TEST(result_real_is_ok); BOOST_TEST(result_imag_is_ok); result_is_ok = (result_real_is_ok && result_imag_is_ok && result_is_ok); std::stringstream strm { }; strm << "result_real_is_ok: " << std::boolalpha << result_real_is_ok << ", result_imag_is_ok: " << std::boolalpha << result_imag_is_ok; std::cout << strm.str() << std::endl; }
    { const auto result_real_is_ok = util::is_close_fraction(result_26.real(), control_26.real(), tol); const auto result_imag_is_ok = util::is_close_fraction(result_26.imag(), control_26.imag(), tol); BOOST_TEST(result_real_is_ok); BOOST_TEST(result_imag_is_ok); result_is_ok = (result_real_is_ok && result_imag_is_ok && result_is_ok); std::stringstream strm { }; strm << "result_real_is_ok: " << std::boolalpha << result_real_is_ok << ", result_imag_is_ok: " << std::boolalpha << result_imag_is_ok; std::cout << strm.str() << std::endl; }
    ...
    { const auto result_real_is_ok = util::is_close_fraction(result_34.real(), control_34.real(), tol); const auto result_imag_is_ok = util::is_close_fraction(result_34.imag(), control_34.imag(), tol); BOOST_TEST(result_real_is_ok); BOOST_TEST(result_imag_is_ok); result_is_ok = (result_real_is_ok && result_imag_is_ok && result_is_ok); std::stringstream strm { }; strm << "result_real_is_ok: " << std::boolalpha << result_real_is_ok << ", result_imag_is_ok: " << std::boolalpha << result_imag_is_ok; std::cout << strm.str() << std::endl; }
    { const auto result_real_is_ok = util::is_close_fraction(result_35.real(), control_35.real(), tol); const auto result_imag_is_ok = util::is_close_fraction(result_35.imag(), control_35.imag(), tol); BOOST_TEST(result_real_is_ok); BOOST_TEST(result_imag_is_ok); result_is_ok = (result_real_is_ok && result_imag_is_ok && result_is_ok); std::stringstream strm { }; strm << "result_real_is_ok: " << std::boolalpha << result_real_is_ok << ", result_imag_is_ok: " << std::boolalpha << result_imag_is_ok; std::cout << strm.str() << std::endl; }
    { const auto result_real_is_ok = util::is_close_fraction(result_36.real(), control_36.real(), tol); const auto result_imag_is_ok = util::is_close_fraction(result_36.imag(), control_36.imag(), tol); BOOST_TEST(result_real_is_ok); BOOST_TEST(result_imag_is_ok); result_is_ok = (result_real_is_ok && result_imag_is_ok && result_is_ok); std::stringstream strm { }; strm << "result_real_is_ok: " << std::boolalpha << result_real_is_ok << ", result_imag_is_ok: " << std::boolalpha << result_imag_is_ok; std::cout << strm.str() << std::endl; }
